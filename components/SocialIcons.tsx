...
function IconLink({
  ...
  return (
    <a
      ...
      className="w-8 h-8 flex items-center justify-center rounded-full opacity-70 hover:opacity-100 transition-opacity"
    >
      {children}
    </a>
  );
...
export default function SocialIcons({ size = 17 }: { size?: number }) {
  const s = size;
  return (
